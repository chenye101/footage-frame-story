...
<h1 className="font-display text-5xl font-bold leading-none tracking-tight sm:text-7xl lg:text-9xl">Cheyne Hoesli</h1>
...
<h2 className="section-title">How Much?</h2>
    <div className="mt-14 grid border-x border-b border-border md:grid-cols-3 md:divide-x md:divide-border">
      ...
      <article className="flex flex-col border-t-2 border-service-gold bg-card p-8 sm:p-10">
        ...
        <p className="mt-3 text-xs leading-5 text-muted-foreground">Brand films, social content, commercials — one cinematic standard across all of it.</p>
        <ul className="mt-8 space-y-6 border-t border-border pt-8">
          <li>
            <div className="flex items-baseline justify-between">
              <span className="text-xs font-medium uppercase tracking-[0.12em] text-foreground">Single Commercial</span>
              <span className="text-sm text-primary">$500</span>
            </div>
            <p className="mt-1 text-xs leading-5 text-muted-foreground">1 primary video (15–45 sec), 2 rounds of revisions. Raw B-roll available at $50/clip.</p>
          </li>
          <li>
            <div className="flex items-baseline justify-between">
              <span className="text-xs font-medium uppercase tracking-[0.12em] text-foreground">Content Duo</span>
              <span className="text-sm text-primary">$950</span>
            </div>
            <p className="mt-1 text-xs leading-5 text-muted-foreground">2 primary videos, 2 rounds of revisions each, 2 complimentary B-roll clips. Ideal for two distinct calendar beats.</p>
          </li>
          <li>
            <div className="flex items-baseline justify-between">
              <span className="text-xs font-medium uppercase tracking-[0.12em] text-foreground">2-Month Bundle</span>
              <span className="text-sm text-primary">$1,300</span>
            </div>
            <p className="mt-1 text-xs leading-5 text-muted-foreground">3 primary videos across 2 months, 4 complimentary B-roll clips. Best for seasonal campaigns.</p>
          </li>
        </ul>
        <div className="mt-6 border-t border-border pt-6">
          <div className="flex items-baseline justify-between">
            <span className="text-xs uppercase tracking-[0.12em] text-muted-foreground">Paid Ad Audio Licensing</span>
            <span className="text-sm text-primary">+$150/video</span>
          </div>
          <p className="mt-1 text-xs leading-5 text-muted-foreground">Royalty-free or custom music licensed for paid ads.</p>
        </div>
      ...
      <article className="flex flex-col border-t-2 border-service-pink bg-card p-8 sm:p-10">
        ...
        <p className="mt-3 text-xs leading-5 text-muted-foreground">Every event is different. Pricing is built around your specific scope, location, and deliverables.</p>
        <ul className="mt-8 space-y-4 border-t border-border pt-8">
          <li className="text-xs leading-6 text-muted-foreground">— Duration & location of the event</li>
          <li className="text-xs leading-6 text-muted-foreground">— Number of deliverables</li>
          <li className="text-xs leading-6 text-muted-foreground">— Turnaround time required</li>
          <li className="text-xs leading-6 text-muted-foreground">— Any specific equipment needs</li>
        </ul>
      ...
      <article className="flex flex-col border-t-2 border-service-blue bg-card p-8 sm:p-10">
        ...
        <p className="mt-3 text-xs leading-5 text-muted-foreground">Anything can be cinematic. If your project doesn't fit a package, reach out — custom scopes are always on the table.</p>
      ...
      <section id="contact" className="section-shell scroll-mt-20 border-t border-border bg-surface relative">
        ...
        <div className="mx-auto grid max-w-[1180px] gap-16 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
         ...
         <label className="field-label">Project type<select className="field-input" name="projectType" defaultValue=""><option value="" disabled>Select a service</option><option>Video Production</option><option>Event Coverage</option><option>Something Else</option></select></label>
<label className="field-label">Budget range<select className="field-input" name="budget" defaultValue=""><option value="" disabled>Select a range</option><option>Under $500</option><option>$500 – $1,000</option><option>$1,000 – $1,500</option><option>$1,500+</option><option>Custom / Not sure</option></select></label>
